    ...
    <Portal container={container}>
      <Content
        ...
        className={cn(
          ...
          'border-gray-200 biz-dark-1:border-gray-700 bg-surface-background z-[300] mt-1.5 max-h-[var(--radix-dropdown-menu-content-available-height)] w-[244px] overflow-auto rounded-md border py-1 shadow-lg focus:outline-none',
          className,
        )}
        {...props}
      >
